...
<?php include 'header.php' ; ?>        <!-- Header Ends -->
        ...
        <div class="warper container-fluid">
            ...
            <div class="page-header"><h1>Mail Compose <small>                        
</h1></div>
                	...
                	<!--<div class="panel panel-default">
                        <div class="panel-body">-->
                                  ...
                                  <div class="form-group">
                                      <input type="email" class="form-control" placeholder="to" name="mail_to" value="<?php echo $mail_from; ?>">
                                  </div>
                                  <div class="form-group">
              <input type="text" class="form-control" value="<?php echo $subject; ?>" placeholder="<?php echo $subject; ?>" name="mail_subject" >
                                  </div>
                                  <div class="form-group">
                      <textarea  class="wysihtml form-control" value="non"  name="mail_body"  placeholder="Message body" style="height: 200px">
				in reply to:
